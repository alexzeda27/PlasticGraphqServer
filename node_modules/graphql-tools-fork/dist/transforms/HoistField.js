        ...
        this.transformer = new MapFields_1.default((_a = {},
            _a[typeName] = (_b = {},
                _b[newFieldName] = function (fieldNode) {
                    return utils_1.wrapFieldNode(utils_1.renameFieldNode(fieldNode, _this.oldFieldName), _this.pathToField);
                },
                _b),
            _a));
    }
    HoistField.prototype.transformSchema = function (schema) {
        ...
        fields_1.appendFields(typeMap, this.typeName, (_a = {},
            _a[this.newFieldName] = {
                type: targetType,
                resolve: stitching_1.createMergedResolver({ fromPath: this.pathToField }),
            },
            _a));
