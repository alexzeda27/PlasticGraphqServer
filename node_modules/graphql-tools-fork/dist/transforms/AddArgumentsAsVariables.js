...
var AddArgumentsAsVariablesTransform = /** @class */ (function () {
    function AddArgumentsAsVariablesTransform(targetSchema, args) {
        this.targetSchema = targetSchema;
        this.args = args;
    }
    AddArgumentsAsVariablesTransform.prototype.transformRequest = function (originalRequest) {
        var _a = addVariablesToRootField(this.targetSchema, originalRequest.document, this.args), document = _a.document, newVariables = _a.newVariables;
...
function addVariablesToRootField(targetSchema, document, args) {
    ...
    var newOperations = operations.map(function (operation) {
        var originalVariableDefinitions = operation.variableDefinitions;
        var existingVariables = originalVariableDefinitions.map(function (variableDefinition) {
                ...
                if (type != null) {
                    ...
                    field.args.forEach(function (argument) {
                        if (argument.name in args) {
                            ...
                            newVariables[variableName] = utils_1.serializeInputValue(argument.type, args[argument.name]);
                        }
                    });
                }
        ...
        return __assign(__assign({}, operation), { variableDefinitions: originalVariableDefinitions.concat(Object.keys(variables).map(function (varName) { return variables[varName]; })), selectionSet: {
