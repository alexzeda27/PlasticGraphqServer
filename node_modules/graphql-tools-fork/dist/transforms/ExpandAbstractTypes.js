...
function expandAbstractTypes(targetSchema, mapping, reverseMapping, document) {
    ...
    return graphql_1.visit(newDocument, graphql_1.visitWithTypeInfo(typeInfo, (_a = {},
        _a[graphql_1.Kind.SELECTION_SET] = function (node) {
            ...
            if (maybeType != null) {
                var parentType_1 = graphql_1.getNamedType(maybeType);
                            ...
                            if (possibleTypes != null) {
                                possibleTypes.forEach(function (possibleType) {
                                    ...
                                    if (maybePossibleType != null &&
                                        implementsAbstractType_1.default(targetSchema, parentType_1, maybePossibleType)) {
                                        newSelections.push({
                        ...
                        if (replacements != null) {
                            replacements.forEach(function (replacement) {
                                ...
                                if (maybeReplacementType != null &&
                                    implementsAbstractType_1.default(targetSchema, parentType_1, maybeType)) {
                                    newSelections.push({
