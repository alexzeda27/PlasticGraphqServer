        ...
        if (graphql_1.isObjectType(typeCandidates[typeName][0].type)) {
            ...
            if (mergeTypes === true ||
                ...
                var requiredSelections_1 = [
                    utils_1.parseSelectionSet('{ __typename }').selections[0],
                ];
                ...
                mergedTypeCandidates.forEach(function (typeCandidate) {
                    ...
                    if (mergedTypeConfig.selectionSet) {
                        var selectionSet = utils_1.parseSelectionSet(mergedTypeConfig.selectionSet);
                ...
                subschemas_1.forEach(function (subschema) {
                    ...
                    subschemas_1
                        ...
                        if (selectionSet != null &&
                            utils_1.typeContainsSelectionSet(type, selectionSet)) {
    ...
    Object.keys(resolvers).forEach(function (typeName) {
        ...
        Object.keys(type).forEach(function (fieldName) {
            ...
            if (field.selectionSet) {
                var selectionSet = utils_1.parseSelectionSet(field.selectionSet);
