...
function delegateRequest(_a) {
    ...
    var delegationTransforms = buildDelegationTransforms(subschemaOrSubschemaConfig, info, context, targetSchema, fieldName, returnType, requestTransforms.reverse(), skipTypeMerging);
    var processedRequest = transforms_1.applyRequestTransforms(request, delegationTransforms);
    if (!skipValidation) {
