...
function assertResolversPresent(schema, resolverValidationOptions) {
    ...
    utils_1.forEachField(schema, function (field, typeName, fieldName) {
        ...
        if (requireResolversForNonScalar &&
            !graphql_1.isScalarType(graphql_1.getNamedType(field.type))) {
            expectResolver(field, typeName, fieldName);
        }
    });
}
function expectResolver(field, typeName, fieldName) {
    ...
    if (typeof field.resolve !== 'function') {
        throw new SchemaError_1.default("Resolver \"" + typeName + "." + fieldName + "\" must be a function");
    }
}
exports.default = assertResolversPresent;
