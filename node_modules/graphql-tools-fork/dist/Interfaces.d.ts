import { GraphQLSchema, GraphQLField, ExecutionResult, GraphQLInputType, GraphQLType, GraphQLNamedType, GraphQLFieldResolver, GraphQLResolveInfo, GraphQLIsTypeOfFn, GraphQLTypeResolver, GraphQLScalarType, DocumentNode, FieldNode, GraphQLEnumValue, GraphQLEnumType, GraphQLUnionType, GraphQLArgument, GraphQLInputField, GraphQLInputObjectType, GraphQLInterfaceType, GraphQLObjectType, InlineFragmentNode, GraphQLOutputType, SelectionSetNode } from 'graphql';
...
export declare type SubschemaConfig = {
...
export declare type MergedTypeConfig = {
    selectionSet?: string;
    fieldName?: string;
...
export declare type IDelegateRequestOptions = {
    request: Request;
...
export declare type ReplacementSelectionSetMapping = {
    [typeName: string]: {
        [fieldName: string]: SelectionSetNode;
    };
};
export declare type ReplacementFragmentMapping = {
    [typeName: string]: {
        [fieldName: string]: InlineFragmentNode;
    };
};
export declare type MergedTypeInfo = {
